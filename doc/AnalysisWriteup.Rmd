...
To give more detail, look at what the (barely) custom *Map_Regression* function looks like. 
...
Now would be a good time to introduce another helpful function. At any point, you can see the underlying graph that drives the workflow with the *tar_visnetwork* function. Here is what this network looks like right now. 
