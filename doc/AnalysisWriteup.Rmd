...
## Getting into the targets workflow

With that general workflow above, the next part is how to actually go about implementing it in code. Some parts like reading in the cross data, and inspecting the basic structure of the data are fairly straightforward as they are natively implemented in r/QTL and all you have to do is work the respective functions into the workflow. 

This get challenging (but interesting) when you want to fit many QTL models, and then compare their results. This is much more challenging to do as the project can very quickly become large and difficult to manage. The targets and related packages provide a way for a researcher to keep the analysis organized, easier to understand, and provides tools to quickly and painlessly scale your project. 

The rest of this document will go through a pipeline I made for a QTL analysis. 
